...
final class DrinkOptionCell: UITableViewCell {
    ...
    private func setupConstraints() {
        ...
        subtitleLabel.setContentHuggingPriority(UILayoutPriority.defaultHigh, for: .horizontal)
    }
    
    private func makeLabel() -> UILabel {
        let label = UILabel()
        label.font = .systemFont(ofSize: 18.0, weight: UIFont.Weight.regular)
        label.textColor = POSColor.darkText
    ...
    private func makeButton() -> DrinkOptionCellButton {
        ...
        view.tintColor = POSColor.darkText
    ...
    private func makeSeparator() -> UIView {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = POSColor.separator
        return view
    }
}
