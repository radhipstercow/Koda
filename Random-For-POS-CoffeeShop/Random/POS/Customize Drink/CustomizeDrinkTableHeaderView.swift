...
final class CustomizeDrinkTableHeaderView: UIView {
    ...
    private func setupConstraints() {
        ...
        descriptionLabel.setContentCompressionResistancePriority(UILayoutPriority.defaultHigh, for: .vertical)
    }
    ...
    private func makeTitleLabel() -> UILabel {
        let font = UIFont.systemFont(ofSize: 21.0, weight: UIFont.Weight.medium)
        return makeLabel(font: font, color: POSColor.darkText)
    }
    
    private func makeDescriptionLabel() -> UILabel {
        let font = UIFont.systemFont(ofSize: 18.0, weight: UIFont.Weight.regular)
        return makeLabel(font: font, color: POSColor.lightText)
    }
