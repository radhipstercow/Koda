...
extension CustomizeDrinkViewController: UIScrollViewDelegate {
    ...
    private func updateCancelButton() {
        ...
        customizeDrinkView.cancelButton.tintColor = cancelButtonIntersectsHeaderImage ? .white : POSColor.darkText
    }
}
