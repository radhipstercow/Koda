...
final class CheckoutButton: UIButton {
    ...
    private func commonInit() {
        ...
        backgroundColor = POSColor.buttonBackground
        setupTitleLabel()
        setupDetailLabel()
    }
    ...
    private func setupTitleLabel() {
        let attributedTitle = NSAttributedString(string: "Check Out", attributes: [
            NSAttributedString.Key.font: UIFont.systemFont(ofSize: 21.0, weight: UIFont.Weight.medium),
    ...
    private func setupDetailLabel() {
        ...
        detailLabel.font = .systemFont(ofSize: 21.0, weight: UIFont.Weight.medium)
